...
func (p TPMType) String() string {
  switch p {
  case TPMType_UNKNOWN: return "UNKNOWN"
  case TPMType_TPM12: return "TPM12"
  case TPMType_TPM20: return "TPM20"
  }
  return "<UNSET>"
}
...
func TPMTypeFromString(s string) (TPMType, error) {
  switch s {
  case "UNKNOWN": return TPMType_UNKNOWN, nil 
  case "TPM12": return TPMType_TPM12, nil 
  case "TPM20": return TPMType_TPM20, nil 
  }
...
func (p CompressionType) String() string {
  ...
  case CompressionType_XZ: return "XZ"
  }
  return "<UNSET>"
}
...
func CompressionTypeFromString(s string) (CompressionType, error) {
  switch s {
  case "None": return CompressionType_None, nil 
  case "XZ": return CompressionType_XZ, nil 
  }
...
func (p DataSource) String() string {
  switch p {
  case DataSource_RawBlob: return "RawBlob"
  case DataSource_Manifold: return "Manifold"
  }
  return "<UNSET>"
}
...
func DataSourceFromString(s string) (DataSource, error) {
  switch s {
  case "RawBlob": return DataSource_RawBlob, nil 
  case "Manifold": return DataSource_Manifold, nil 
  }
...
func (p BuildMode) String() string {
  switch p {
  case BuildMode_Undefined: return "Undefined"
  case BuildMode_opt: return "opt"
  case BuildMode_dev: return "dev"
  }
  return "<UNSET>"
}
...
func BuildModeFromString(s string) (BuildMode, error) {
  switch s {
  case "Undefined": return BuildMode_Undefined, nil 
  case "opt": return BuildMode_opt, nil 
  case "dev": return BuildMode_dev, nil 
  }
...
func (p ErrorClass) String() string {
  switch p {
  case ErrorClass_InternalError: return "InternalError"
  case ErrorClass_InvalidInput: return "InvalidInput"
  case ErrorClass_NotSupported: return "NotSupported"
  }
  return "<UNSET>"
}
...
func ErrorClassFromString(s string) (ErrorClass, error) {
  switch s {
  case "InternalError": return ErrorClass_InternalError, nil 
  case "InvalidInput": return ErrorClass_InvalidInput, nil 
  case "NotSupported": return ErrorClass_NotSupported, nil 
  }
...
func (p *PCRValue) Equals(other *PCRValue) bool {
  ...
  if bytes.Compare(p.Original, other.Original) != 0 { return false }
  if bytes.Compare(p.Received, other.Received) != 0 { return false }
  if bytes.Compare(p.LastReported, other.LastReported) != 0 { return false }
  if bytes.Compare(p.EventLog, other.EventLog) != 0 { return false }
  if bytes.Compare(p.TPM, other.TPM) != 0 { return false }
  if bytes.Compare(p.RTPFWTable, other.RTPFWTable) != 0 { return false }
  return true
}
...
func (p *PCRValues) Equals(other *PCRValues) bool {
  ...
  if !p.PCR0SHA1.Equals(other.PCR0SHA1) { return false }
  if !p.PCR0SHA256.Equals(other.PCR0SHA256) { return false }
  return true
}
...
func (p *VendorSpecificDiagInfo) Equals(other *VendorSpecificDiagInfo) bool {
  ...
  if !p.Intel.Equals(other.Intel) { return false }
  return true
}
...
func (p *IntelDiagInfo) Equals(other *IntelDiagInfo) bool {
  ...
  if !p.ACM.Equals(other.ACM) { return false }
  return true
}
...
func (p *HostInfo) Equals(other *HostInfo) bool {
  ...
  if p.SerialNumber != other.SerialNumber {
    ...
    if (*p.SerialNumber) != (*other.SerialNumber) { return false }
  }
  ...
  if p.IsVerified != other.IsVerified { return false }
  if p.IsClientHostAnalyzed != other.IsClientHostAnalyzed { return false }
  return true
}
...
func (p *ServerInfo) Equals(other *ServerInfo) bool {
  ...
  if p.BuildMode != other.BuildMode { return false }
  return true
}
...
func (p *SearchFirmwareRequest) Equals(other *SearchFirmwareRequest) bool {
  ...
  if len(p.OrFilters) != len(other.OrFilters) { return false }
  for i, _tgt := range p.OrFilters {
    _src1 := other.OrFilters[i]
    if !_tgt.Equals(_src1) { return false }
  }
  if p.FetchContent != other.FetchContent { return false }
  return true
}
...
func (p *SearchFirmwareFilters) Equals(other *SearchFirmwareFilters) bool {
  ...
  if bytes.Compare(p.ImageID, other.ImageID) != 0 { return false }
  if bytes.Compare(p.HashSHA2_512, other.HashSHA2_512) != 0 { return false }
  if bytes.Compare(p.HashBlake3_512, other.HashBlake3_512) != 0 { return false }
  if bytes.Compare(p.HashStable, other.HashStable) != 0 { return false }
...
func (p *SearchFirmwareResult_) Equals(other *SearchFirmwareResult_) bool {
  ...
  if len(p.Found) != len(other.Found) { return false }
...
func (p *FirmwareImageMetadata) Equals(other *FirmwareImageMetadata) bool {
  ...
  if p.TSUpload != other.TSUpload {
    ...
    if (*p.TSUpload) != (*other.TSUpload) { return false }
  }
  return true
}
...
func (p *SearchReportFilters) Equals(other *SearchReportFilters) bool {
  ...
  if !p.ActualFirmware.Equals(other.ActualFirmware) { return false }
  return true
}
...
func (p *CompressedBlob) Equals(other *CompressedBlob) bool {
  ...
  if bytes.Compare(p.Blob, other.Blob) != 0 { return false }
  if p.Compression != other.Compression { return false }
  return true
}
...
func (p *FirmwareImage) Equals(other *FirmwareImage) bool {
  ...
  if !p.Blob.Equals(other.Blob) { return false }
  if p.Filename != other.Filename {
    if p.Filename == nil || other.Filename == nil {
      return false
    }
  ...
  if bytes.Compare(p.ManifoldID, other.ManifoldID) != 0 { return false }
  if p.EverstoreHandle != other.EverstoreHandle {
    if p.EverstoreHandle == nil || other.EverstoreHandle == nil {
      return false
    }
    if (*p.EverstoreHandle) != (*other.EverstoreHandle) { return false }
  }
  if !p.FwVersion.Equals(other.FwVersion) { return false }
  return true
}
...
func (p *Artifact) Equals(other *Artifact) bool {
  ...
  if !p.FwImage.Equals(other.FwImage) { return false }
  if !p.Pcr.Equals(other.Pcr) { return false }
  ...
  if p.MeasurementsFlow != other.MeasurementsFlow {
    ...
    if (*p.MeasurementsFlow) != (*other.MeasurementsFlow) { return false }
  }
  return true
}
...
func (p *DiffMeasuredBootInput) Equals(other *DiffMeasuredBootInput) bool {
  ...
  if p.StatusRegisters != other.StatusRegisters {
    ...
    if (*p.StatusRegisters) != (*other.StatusRegisters) { return false }
  }
  if p.TPMDevice != other.TPMDevice {
    if p.TPMDevice == nil || other.TPMDevice == nil {
      return false
  ...
  if p.TPMEventLog != other.TPMEventLog {
    ...
    if (*p.TPMEventLog) != (*other.TPMEventLog) { return false }
  }
  if p.ActualPCR0 != other.ActualPCR0 {
    if p.ActualPCR0 == nil || other.ActualPCR0 == nil {
      return false
    }
    if (*p.ActualPCR0) != (*other.ActualPCR0) { return false }
  }
  return true
}
...
func (p *ReproducePCRInput) Equals(other *ReproducePCRInput) bool {
  ...
  if p.ExpectedPCR != other.ExpectedPCR { return false }
  if p.MeasurementsFlow != other.MeasurementsFlow {
    if p.MeasurementsFlow == nil || other.MeasurementsFlow == nil {
      return false
    }
...
func (p *AnalyzerInput) Equals(other *AnalyzerInput) bool {
  ...
  if !p.DiffMeasuredBoot.Equals(other.DiffMeasuredBoot) { return false }
  if !p.IntelACM.Equals(other.IntelACM) { return false }
  if !p.ReproducePCR.Equals(other.ReproducePCR) { return false }
  if !p.PSPSignature.Equals(other.PSPSignature) { return false }
  if !p.BIOSRTMVolume.Equals(other.BIOSRTMVolume) { return false }
  if !p.APCBSecurityTokens.Equals(other.APCBSecurityTokens) { return false }
  return true
}
...
func (p *Error) Equals(other *Error) bool {
  ...
  if p.ErrorClass != other.ErrorClass { return false }
...
func (p *AnalyzerResult_) Equals(other *AnalyzerResult_) bool {
  ...
  if p.AnalyzerName != other.AnalyzerName { return false }
  if !p.AnalyzerOutcome.Equals(other.AnalyzerOutcome) { return false }
  if p.ProcessedInputJSON != other.ProcessedInputJSON {
    if p.ProcessedInputJSON == nil || other.ProcessedInputJSON == nil {
      return false
    }
    if (*p.ProcessedInputJSON) != (*other.ProcessedInputJSON) { return false }
  }
  return true
}
...
func (p *AnalyzerOutcome) Equals(other *AnalyzerOutcome) bool {
  ...
  if !p.Report.Equals(other.Report) { return false }
