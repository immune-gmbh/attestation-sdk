...
func (p *ACMInfo) Equals(other *ACMInfo) bool {
  ...
  if p.SESVN != other.SESVN { return false }
  if p.TXTSVN != other.TXTSVN { return false }
  return true
}
...
func (p *IntelACMDiagInfo) Equals(other *IntelACMDiagInfo) bool {
  ...
  if !p.Original.Equals(other.Original) { return false }
  if !p.Received.Equals(other.Received) { return false }
  return true
}
