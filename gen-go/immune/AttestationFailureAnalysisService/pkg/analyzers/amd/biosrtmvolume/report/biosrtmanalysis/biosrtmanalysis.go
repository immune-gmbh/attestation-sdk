...
func (p Validation) String() string {
  ...
  case Validation_CorrectSignature: return "CorrectSignature"
  case Validation_RTMVolumeNotFound: return "RTMVolumeNotFound"
  case Validation_RTMSignatureNotFound: return "RTMSignatureNotFound"
  case Validation_PSBDisabled: return "PSBDisabled"
  case Validation_InvalidFormat: return "InvalidFormat"
  case Validation_IncorrectSignature: return "IncorrectSignature"
  }
  return "<UNSET>"
}
...
func ValidationFromString(s string) (Validation, error) {
  switch s {
  case "Unknown": return Validation_Unknown, nil 
  case "CorrectSignature": return Validation_CorrectSignature, nil 
  case "RTMVolumeNotFound": return Validation_RTMVolumeNotFound, nil 
  case "RTMSignatureNotFound": return Validation_RTMSignatureNotFound, nil 
  case "PSBDisabled": return Validation_PSBDisabled, nil 
  case "InvalidFormat": return Validation_InvalidFormat, nil 
  case "IncorrectSignature": return Validation_IncorrectSignature, nil 
  }
...
func (p *PlatformBindingInfo) Equals(other *PlatformBindingInfo) bool {
  ...
  if p.VendorID != other.VendorID { return false }
  if p.KeyRevisionID != other.KeyRevisionID { return false }
  if p.PlatformModelID != other.PlatformModelID { return false }
  return true
}
...
func (p *SecurityFeatureVector) Equals(other *SecurityFeatureVector) bool {
  ...
  if p.DisableBIOSKeyAntiRollback != other.DisableBIOSKeyAntiRollback { return false }
  if p.DisableAMDBIOSKeyUse != other.DisableAMDBIOSKeyUse { return false }
  if p.DisableSecureDebugUnlock != other.DisableSecureDebugUnlock { return false }
  return true
}
...
func (p *BIOSRTMVolume) Equals(other *BIOSRTMVolume) bool {
  ...
  if p.BIOSDirectoryLevel != other.BIOSDirectoryLevel { return false }
  if p.ValidationResult_ != other.ValidationResult_ { return false }
  if p.ValidationDescription != other.ValidationDescription { return false }
  if !p.PlatformInfo.Equals(other.PlatformInfo) { return false }
  if !p.SecurityFeatures.Equals(other.SecurityFeatures) { return false }
  return true
}
