...
func (p TokenID) String() string {
  switch p {
  case TokenID_PSPMeasureConfig: return "PSPMeasureConfig"
  case TokenID_PSPEnableDebugMode: return "PSPEnableDebugMode"
  case TokenID_PSPErrorDisplay: return "PSPErrorDisplay"
  case TokenID_PSPStopOnError: return "PSPStopOnError"
  }
  return "<UNSET>"
}
...
func TokenIDFromString(s string) (TokenID, error) {
  switch s {
  case "PSPMeasureConfig": return TokenID_PSPMeasureConfig, nil 
  case "PSPEnableDebugMode": return TokenID_PSPEnableDebugMode, nil 
  case "PSPErrorDisplay": return TokenID_PSPErrorDisplay, nil 
  case "PSPStopOnError": return TokenID_PSPStopOnError, nil 
  }
...
func (p *TokenValue) Equals(other *TokenValue) bool {
  ...
  if p.Boolean != other.Boolean {
    ...
    if (*p.Boolean) != (*other.Boolean) { return false }
  }
  if p.Byte != other.Byte {
    if p.Byte == nil || other.Byte == nil {
      return false
    }
    if (*p.Byte) != (*other.Byte) { return false }
  }
  ...
  if p.DWord != other.DWord {
    ...
    if (*p.DWord) != (*other.DWord) { return false }
  }
  return true
}
...
func (p *Token) Equals(other *Token) bool {
  ...
  if p.PriorityMask != other.PriorityMask { return false }
  if p.BoardMask != other.BoardMask { return false }
...
func (p *CustomReport) Equals(other *CustomReport) bool {
  ...
  if len(p.DirectoryTokens) != len(other.DirectoryTokens) { return false }
