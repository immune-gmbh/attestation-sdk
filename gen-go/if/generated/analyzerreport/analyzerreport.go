...
func (p Severity) String() string {
  switch p {
  case Severity_SeverityUnknown: return "SeverityUnknown"
  case Severity_SeverityInfo: return "SeverityInfo"
  case Severity_SeverityWarning: return "SeverityWarning"
  case Severity_SeverityCritical: return "SeverityCritical"
  }
  return "<UNSET>"
}
...
func SeverityFromString(s string) (Severity, error) {
  switch s {
  case "SeverityUnknown": return Severity_SeverityUnknown, nil 
  case "SeverityInfo": return Severity_SeverityInfo, nil 
  case "SeverityWarning": return Severity_SeverityWarning, nil 
  case "SeverityCritical": return Severity_SeverityCritical, nil 
  }
...
func (p *Issue) Equals(other *Issue) bool {
  ...
  if !p.Custom.Equals(other.Custom) { return false }
...
func (p *AnalyzerReport) Equals(other *AnalyzerReport) bool {
  ...
  if !p.Custom.Equals(other.Custom) { return false }
  if len(p.Issues) != len(other.Issues) { return false }
  for i, _tgt := range p.Issues {
    _src2 := other.Issues[i]
    if !_tgt.Equals(_src2) { return false }
  }
  if len(p.Comments) != len(other.Comments) { return false }
